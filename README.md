...
The presenter method for## Unreleased / Experimental
...
# TODO
 ...
 - Better documentation and examples the view. `View.present` is intended to be called on the results of a template rendered with `View.render()`. In the <a href"#presenter">presenter</a>, you can apply Level 2 DOM Events to the rendered markup. In simple use-cases, you will not use this method.
